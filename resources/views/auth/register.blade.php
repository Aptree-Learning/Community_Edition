<x-auth-layout>
    <x-authentication-card>
        ...
        <div class="text-center">
            <h1 class="text-primary text-3xl font-bold">Create your account</h1>
        ...
        <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-2 text-sm">
                            {!! __('By creating an account means you agree to the<br> :terms_of_service and our :privacy_policy', [
                                'terms_of_service' =>
                                    '<a target="_blank" href="https://docs.aptreelearning.com/terms" class="text-sm font-bold text-gray-900 underline rounded-md hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">' .
                                    __('Terms of Service') .
                                    '</a>',
                                'privacy_policy' =>
                                    '<a target="_blank" href="https://docs.aptreelearning.com/privacy" class="text-sm font-bold text-gray-900 underline rounded-md hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">' .
                                    __('Privacy Policy') .
                                    '</a>',
                            ]) !!}
                        </div>
            ...
            <div class="mt-4">
                <button type="submit" class="btn-primary w-full font-bold">Register</button>
            </div>
            ...
            <div class="mt-4 flex items-center justify-center">
                ...
                <a class="text-primary ml-1 rounded-md text-sm font-bold underline hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    href="{{ route('login') }}">
                    {{ __('Log In') }}
                </a>
            </div>
